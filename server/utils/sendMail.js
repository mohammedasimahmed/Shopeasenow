...
export const sendMailer = async (email, otp, UserName, template) => {
  try {
    ...
    if (template === "registration") {
      subject = "Welcome to Shopeasenow - Registration OTP";
      text = `Hello ${UserName},\n\n +
                Thank you for choosing Shopeasenow! You're just one step away from getting started. +
                Here's your OTP for registration:\n\n +
                OTP: ${otp}\n\n +
                Simply enter this OTP to complete your registration process. +
                If you have any questions or need assistance, feel free to contact us.\n\n +
                Best regards,\n +
                The Shopeasenow Team`;
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td style="padding: 20px 0;">
                    ...
                    <p style="font-size: 16px; color: #666666;">Thank you for choosing Shopeasenow! You're just one step away
                    ...
                    <p style="font-size: 16px; color: #666666;">Best regards,<br>The Shopeasenow Team</p>
                  </td>
                </tr>
              </table>
            </td>
      ...
      text = `Hello ${UserName} ,\n\n +
                You have requested a password reset for your Shopeasenow account. +
            ...
            <td style="padding: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td>
                    <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                    <p style="font-size: 16px; color: #666666;">You have requested a password reset for your Shopeasenow
                      account.</p>
                ...
                <tr>
                  <td>
                    ...
                    <p style="font-size: 16px; color: #333333; font-weight: bold;">The Shopeasenow Team</p>
                  </td>
                </tr>
              </table>
            </td>
      ...
      text = `Hello ${UserName},\n\n +
                You have requested the deletion of your account for your Shopeasenow account. +
                ...
                Before deleting your account, please ensure that you've backed up any important data associated with your Shopeasenow account.\n\n +
                Best regards,\n +
                The Shopeasenow Team`;
                ...
                <tr>
                  <td>
                    ...
                    <p style="font-size: 16px; color: #666666; margin-top: 20px;">Before deleting your account, please ensure
                      that you've backed up any important data associated with your Shopeasenow account.</p>
                  </td>
                </tr>
                <tr>
                  <td>
      ...
      text = ` Hello ${UserName},\n\n +
                Your Shopeasenow account has been successfully deleted as per your request. +
            ...
            <td style="padding: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td>
                    <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                    <p style="font-size: 16px; color: #666666;">Your Shopeasenow account has been successfully deleted as per
                      your request.</p>
      ...
      subject = "Resend OTP";
      text = ` Hello ${UserName},\n\n +
                You have requested to resend the OTP for your Shopeasenow account. +
                Here's your OTP: ${otp}\n\n +
              ...
              <td style="padding: 30px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td>
                      <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                      <p style="font-size: 16px; color: #666666;">You have requested to resend the OTP for your Shopeasenow account.</p>
    ...
    const mailOptions = {
      from: `'Shopeasenow || by team' <${process.env.USER}>`,
      to: email,
      subject,
      text,
      html,
