          ...
          <div className="bg-gray-50 dark:bg-gray-900">
            <div className="py-4 px-4 mx-auto max-w-[100%]  lg:py-4 grid lg:grid-cols-2 gap-8 lg:gap-6">
              <div className="flex flex-col justify-center">
                <h3 className="text-4xl font-bold text-gray-600 mb-4  tracking-tight leading-none md:text-5xl lg:text-4xl dark:text-[white]">
                  Join SoulShare: <br />
                  <span className="text-4xl font-bold text-gray-600 mb-4  tracking-tight leading-none md:text-5xl lg:text-4xl dark:text-[#51D6FF]">
                    {" "}
                    <Typewriter
