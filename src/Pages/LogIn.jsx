...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Cookies.set("email", data.email); setFormData({
        email: "",
        password: ""
      })
      setIsChecked(false)
  ...
  return (
    <>
      {isLoading ? <Loader /> :
        <div className="h-screen flex flex-row bg-gray-900 select-text">
          <Navbar />
          <section>
              ...
              <div className="py-8 px-4 mx-auto max-w-[100%] lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                <div className="flex flex-col justify-center">
                  ...
                  <p className="mb-6 text-lg font-normal text-gray-500 dark:text-[#8D9EC6]">
                    Step into shopeasenow once more, where sharing surplus ignites
                ...
                <div className="w-full lg:max-w-xl p-6 space-y-10 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                  <div className="text-2xl font-bold tex-gray-900 dark:text-white sm:w-[100%]">
                    <h2>Sign In to Shopeasenow</h2>
                  </div>
                  <form
