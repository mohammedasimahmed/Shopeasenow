...
const Contact = () => {
  ...
  return (
    <>
      <div
        className="relative isolate px-6 pt-14 lg:px-8 w-[100%]"
        id="contact-link"
      >
        <div
          ...
          <div className="py-8 px-4 mx-auto max-w-[100%] lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div className="flex flex-col justify-center">
              ...
              <p className="mb-6 text-lg font-normal text-gray-500 dark:text-[#8D9EC6]">
                Discover a world of endless possibilities at our eCommerce
                store. we offer a curated selection of top-quality products that
                cater to your every need.
              </p>
            </div>
            <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
              <div className="text-2xl font-bold tex-gray-900 dark:text-white sm:w-[100%]">
                <h2>Contact ShopEaseNow</h2>
              </div>
              <form
